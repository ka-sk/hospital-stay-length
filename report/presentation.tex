        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{center}
                \begin{tikzpicture}[scale=0.6]
                    \fill[blue!50] (0,0) rectangle (6.4,0.8);
                    \fill[red!50] (6.4,0) rectangle (8,0.8);
                    \node[font=\small, white] at (3.2,0.4) {\textbf{Trening: 80\%}};
                    \node[font=\small, white] at (7.2,0.4) {\textbf{Test: 20\%}};
                \end{tikzpicture}
            \end{center}
        \end{column}
    \end{columns}
    ...
    \begin{columns}[T]
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}[scale=0.5]
                \foreach \y in {0,0.5,1,1.5,2} \fill[blue!60] (0,\y) circle (0.15);
                \foreach \y in {0.25,0.75,1.25,1.75} \fill[green!60] (1.5,\y) circle (0.15);
                \fill[red!60] (3,1) circle (0.15);

                \foreach \x in {0,0.5,1,1.5,2} {
                    \foreach \y in {0.25,0.75,1.25,1.75} {
                        \draw[gray!50, thin] (0.15,\x) -- (1.35,\y);
                    }
                }
                \foreach \y in {0.25,0.75,1.25,1.75} {
                    \draw[gray!50, thin] (1.65,\y) -- (2.85,1);
                }
            \end{tikzpicture}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}[scale=0.5]
                \fill[blue!60] (0,0) rectangle (2,0.4);
                \fill[orange!60] (0,0.6) rectangle (2,1);
                \fill[green!60] (0,1.2) rectangle (2,1.6);
                \fill[red!60] (0,1.8) rectangle (2,2.2);

                \node[font=\tiny] at (1,0.2) {Input};
                \node[font=\tiny] at (1,0.8) {Attention};
                \node[font=\tiny] at (1,1.4) {Feature Trans.};
                \node[font=\tiny] at (1,2) {Output};
            \end{tikzpicture}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}[scale=0.5]
                \fill[blue!60] (0,0) rectangle (2,0.4);
                \fill[purple!60] (0,0.6) rectangle (2,1);
                \fill[purple!60] (0,1.2) rectangle (2,1.6);
                \fill[red!60] (0,1.8) rectangle (2,2.2);

                \node[font=\tiny] at (1,0.2) {Embeddings};
                \node[font=\tiny] at (1,0.8) {Self-Attention};
                \node[font=\tiny] at (1,1.4) {Self-Attention};
                \node[font=\tiny] at (1,2) {MLP Head};
            \end{tikzpicture}
...
%=============================================================================
\begin{frame}{Porównanie architektur -- metryki testowe}
    \begin{center}
        \includegraphics[width=\textwidth, height=0.82\textheight, keepaspectratio]{figures/architecture_comparison.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Stabilność modeli w walidacji krzyżowej}
    \begin{center}
        \includegraphics[width=0.9\textwidth, height=0.82\textheight, keepaspectratio]{figures/cv_stability.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Wyniki -- najlepsze modele}
    \begin{center}
        ...
        \begin{tabular}{l|ccc|c}
            \toprule
            \textbf{Metryka} & \textbf{SimpleMLP} & \textbf{TabNet} & \textbf{TabTransformer} & \textbf{Najlepszy} \\
            \midrule
            MAE (CV) & 1.286 $\pm$ 0.028 & \cellcolor{green!20}\textbf{1.239 $\pm$ 0.022} & 1.248 $\pm$ 0.026 & TabNet \\
            MAE (Test) & 1.311 & \cellcolor{green!20}\textbf{1.264} & 1.272 & TabNet \\
            RMSE (Test) & 1.675 & \cellcolor{green!20}\textbf{1.597} & 1.618 & TabNet \\
            R² (Test) & 0.641 & \cellcolor{green!20}\textbf{0.674} & 0.669 & TabNet \\
            \bottomrule
        \end{tabular}
...
%=============================================================================
\begin{frame}{Predykcje i reszty -- SimpleMLP}
    \begin{center}
        \includegraphics[width=0.48\textwidth]{figures/mlp_predictions.pdf}
        \includegraphics[width=0.48\textwidth]{figures/mlp_residuals.pdf}
    \end{center}
\end{frame}

%=============================================================================
\begin{frame}{Predykcje i reszty -- TabNet (najlepszy)}
    \begin{center}
        \includegraphics[width=0.48\textwidth]{figures/tabnet_predictions.pdf}
        \includegraphics[width=0.48\textwidth]{figures/tabnet_residuals.pdf}
    \end{center}
\end{frame}

%=============================================================================
\begin{frame}{Predykcje i reszty -- TabTransformer}
    \begin{center}
        \includegraphics[width=0.48\textwidth]{figures/tabtransformer_predictions.pdf}
        \includegraphics[width=0.48\textwidth]{figures/tabtransformer_residuals.pdf}
    \end{center}
\end{frame}
...
\begin{frame}{Wnioski}
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \vspace{0.5cm}
            \textbf{Przyszłe kierunki:}
            \begin{itemize}
                \item Więcej cech medycznych
                \item Przedziały ufności
                \item Walidacja kliniczna
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Dziękujemy za uwagę}
    \begin{center}
        ...
        \vspace{2cm}
        \textbf{Kamil Selega, Katarzyna Szczepaniak}
