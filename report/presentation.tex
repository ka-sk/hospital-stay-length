        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{center}
                \begin{tikzpicture}[scale=0.6]
                    \fill[blue!50] (0,0) rectangle (6,0.8);
                    \fill[red!50] (6,0) rectangle (8,0.8);
                    \node[font=\small, black] at (3,0.4) {\textbf{Trening: 80\%}};
                    \node[font=\footnotesize, black] at (7,0.4) {\textbf{Test: 20\%}};
                \end{tikzpicture}
            \end{center}
        \end{column}
    \end{columns}
...
\begin{frame}{Architektury sieci neuronowych}
    \begin{columns}[T]
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}[scale=0.6]
                \foreach \y in {0,0.5,1,1.5,2} \fill[blue!60] (0,\y) circle (0.18);
                \foreach \y in {0.25,0.75,1.25,1.75} \fill[green!60] (1.5,\y) circle (0.18);
                \fill[red!60] (3,1) circle (0.18);

                \foreach \x in {0,0.5,1,1.5,2} {
                    \foreach \y in {0.25,0.75,1.25,1.75} {
                        \draw[gray!50, thin] (0.18,\x) -- (1.32,\y);
                    }
                }
                \foreach \y in {0.25,0.75,1.25,1.75} {
                    \draw[gray!50, thin] (1.68,\y) -- (2.82,1);
                }
            \end{tikzpicture}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}[scale=0.6]
                \fill[blue!60] (0,0) rectangle (2.8,0.5);
                \fill[orange!60] (0,0.7) rectangle (2.8,1.2);
                \fill[green!60] (0,1.4) rectangle (2.8,1.9);
                \fill[red!60] (0,2.1) rectangle (2.8,2.6);

                \node[font=\scriptsize] at (1.4,0.25) {Input};
                \node[font=\scriptsize] at (1.4,0.95) {Attention};
                \node[font=\scriptsize] at (1.4,1.65) {Feature Trans.};
                \node[font=\scriptsize] at (1.4,2.35) {Output};
            \end{tikzpicture}
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}[scale=0.6]
                \fill[blue!60] (0,0) rectangle (2.8,0.5);
                \fill[purple!60] (0,0.7) rectangle (2.8,1.2);
                \fill[purple!60] (0,1.4) rectangle (2.8,1.9);
                \fill[red!60] (0,2.1) rectangle (2.8,2.6);

                \node[font=\scriptsize] at (1.4,0.25) {Embeddings};
                \node[font=\scriptsize] at (1.4,0.95) {Self-Attention};
                \node[font=\scriptsize] at (1.4,1.65) {Self-Attention};
                \node[font=\scriptsize] at (1.4,2.35) {MLP Head};
            \end{tikzpicture}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Ensemble modeli (TabNet + TabTransformer)
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
